(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,99847,e=>{"use strict";let a=(0,e.i(56420).default)("circle-alert",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]]);e.s(["AlertCircle",0,a],99847)},52330,e=>{"use strict";let a=(0,e.i(56420).default)("code-xml",[["path",{d:"m18 16 4-4-4-4",key:"1inbqp"}],["path",{d:"m6 8-4 4 4 4",key:"15zrgr"}],["path",{d:"m14.5 4-5 16",key:"e7oirm"}]]);e.s(["Code2",0,a],52330)},71136,35184,e=>{"use strict";var a=e.i(56420);let t=(0,a.default)("hash",[["line",{x1:"4",x2:"20",y1:"9",y2:"9",key:"4lhtct"}],["line",{x1:"4",x2:"20",y1:"15",y2:"15",key:"vyu0kd"}],["line",{x1:"10",x2:"8",y1:"3",y2:"21",key:"1ggp8o"}],["line",{x1:"16",x2:"14",y1:"3",y2:"21",key:"weycgp"}]]);e.s(["Hash",0,t],71136);let r=(0,a.default)("type",[["path",{d:"M12 4v16",key:"1654pz"}],["path",{d:"M4 7V5a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2",key:"e0r10z"}],["path",{d:"M9 20h6",key:"s66wpe"}]]);e.s(["Type",0,r],35184)},77071,e=>{"use strict";let a=(0,e.i(56420).default)("plus",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"M12 5v14",key:"s699le"}]]);e.s(["Plus",0,a],77071)},66595,e=>{"use strict";let a=(0,e.i(56420).default)("search",[["path",{d:"m21 21-4.34-4.34",key:"14j7rj"}],["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}]]);e.s(["Search",0,a],66595)},4139,e=>{"use strict";let a=(0,e.i(56420).default)("terminal",[["path",{d:"M12 19h8",key:"baeox8"}],["path",{d:"m4 17 6-6-6-6",key:"1yngyt"}]]);e.s(["Terminal",0,a],4139)},5279,e=>{"use strict";var a=e.i(43476),t=e.i(71645),r=e.i(71034),i=e.i(21357),s=e.i(52330),n=e.i(51757),l=e.i(4139),d=e.i(84026),o=e.i(64569),c=e.i(95925),m=e.i(19455),u=e.i(15288),p=e.i(77572),f=e.i(87486),g=e.i(93479),b=e.i(98898),h=e.i(57086),x=e.i(5192),k=e.i(36421),v=e.i(59009),y=e.i(68042),_=e.i(58841),j=e.i(48107),N=e.i(36841),$=e.i(71816),T=e.i(75157),w=e.i(28783),R=e.i(54204);e.s(["default",0,function(){let{data:e,columns:S,fileName:A,loadDefaultDataset:M}=(0,N.useDatasetStore)(),{tTestConfig:C,setTTestConfig:E,executeTTest:z,tTestResult:P,isCalculating:U,error:D,clearSpecificAnalysis:V}=(0,$.useAnalysisStore)(),[q,L]=t.useState("tables"),[I,B]=t.useState(!0),[K,F]=t.useState(!1),H=t.useRef(!0);t.useEffect(()=>{$.useAnalysisStore.setState({error:null}),0!==e.length||A||M()},[]),t.useEffect(()=>{if(H.current&&(H.current=!1,P)||!I||0===e.length||!("independent"===C.type&&C.dv&&C.groupVar||"paired"===C.type&&C.dv&&C.pairedVar2||"one_sample"===C.type&&C.dv))return;F(!0);let a=setTimeout(()=>{F(!1),z(e)},400);return()=>{clearTimeout(a),F(!1)}},[I,e,C.type,C.dv,C.groupVar,C.pairedVar2,C.testValue]);let G=P?[{testName:"Student's t (Equal var)",tStat:(0,T.formatNumber)(P.statistic),df:P.df,pValue:(0,T.formatPValue)(P.pValue),meanDiff:(0,T.formatNumber)(P.meanDiff),seDiff:(0,T.formatNumber)(P.stdErrorDiff),ciLower:(0,T.formatNumber)(P.ciLower),ciUpper:(0,T.formatNumber)(P.ciUpper),cohensD:(0,T.formatNumber)(P.cohensD)},...void 0!==P.welchStatistic?[{testName:"Welch's t (Unequal var)",tStat:(0,T.formatNumber)(P.welchStatistic),df:(0,T.formatNumber)(P.welchDf,1),pValue:(0,T.formatPValue)(P.welchPValue),meanDiff:(0,T.formatNumber)(P.meanDiff),seDiff:(0,T.formatNumber)(P.stdErrorDiff),ciLower:(0,T.formatNumber)(P.ciLower),ciUpper:(0,T.formatNumber)(P.ciUpper),cohensD:(0,T.formatNumber)(P.cohensD)}]:[]]:[],O=P?.descriptives?.map(e=>({group:e.group,n:e.n,mean:(0,T.formatNumber)(e.mean),sd:(0,T.formatNumber)(e.sd),se:(0,T.formatNumber)(e.se),median:(0,T.formatNumber)(e.median)}))||[],W=R.RSyntaxGenerator.getTTestCode(C.type,C.dv,C.groupVar,C.testValue,C.pairedVar2,A||"data_latihan_jasp_multilevel.csv");return(0,a.jsxs)("div",{className:"space-y-6",children:[(0,a.jsxs)(j.PageHeader,{icon:r.Binary,title:"Uji-t (Independent & Paired t-Test)",badgeIcon:n.CheckCircle2,badgeText:"R Engine (stats::t.test)",description:"Bandingkan rata-rata capaian kelompok sampel independen, berpasangan, atau satu sampel dengan estimasi Cohen's d.",children:[(0,a.jsxs)(m.Button,{type:"button",variant:"outline",size:"sm",onClick:()=>{V("ttest")},className:"text-xs h-9 px-3 gap-1.5 rounded-xl border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 cursor-pointer shadow-2xs font-medium",title:"Bersihkan model dan reset hasil analisis",children:[(0,a.jsx)(c.RotateCcw,{className:"w-3.5 h-3.5"}),"Reset Analisis"]}),(0,a.jsxs)("button",{type:"button",onClick:()=>B(!I),className:(0,T.cn)("text-xs px-3 py-2 rounded-xl font-medium border flex items-center gap-1.5 cursor-pointer transition-all shadow-2xs whitespace-nowrap h-9",I?"bg-teal-50 border-teal-300 text-teal-900 dark:bg-teal-950/80 dark:border-teal-700 dark:text-teal-200 ring-1 ring-teal-500/20":"bg-zinc-100 border-zinc-200 text-zinc-600 dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-400"),title:"Mode Komputasi Reaktif: Hitung otomatis saat variabel diubah seperti di JASP/Jamovi",children:[(0,a.jsx)(o.Zap,{className:(0,T.cn)("w-3.5 h-3.5",I?"text-amber-500 fill-amber-500":"text-zinc-400")}),(0,a.jsxs)("span",{children:["Auto-Run ",I?"Aktif":"Manual"]}),K&&(0,a.jsx)("span",{className:"w-2 h-2 rounded-full bg-amber-500 animate-ping ml-0.5"})]}),(0,a.jsxs)(m.Button,{onClick:()=>{e.length>0&&z(e)},disabled:U||0===e.length,className:"bg-[#008080] hover:bg-[#006666] dark:bg-[#14a3a3] dark:hover:bg-[#0f8787] text-white dark:text-[#04211f] cursor-pointer gap-2 text-xs px-4 py-2 shadow-xs font-semibold rounded-xl whitespace-nowrap h-9",children:[(0,a.jsx)(i.Play,{className:"w-3.5 h-3.5 fill-current"}),"Jalankan Uji-t"]})]}),(0,a.jsxs)(p.Tabs,{value:C.type,onValueChange:e=>{E({type:e})},children:[(0,a.jsxs)(p.TabsList,{className:"bg-zinc-100 dark:bg-zinc-800/80 p-1",children:[(0,a.jsx)(p.TabsTrigger,{value:"independent",children:"Independent Samples t-Test"}),(0,a.jsx)(p.TabsTrigger,{value:"paired",children:"Paired Samples t-Test"}),(0,a.jsx)(p.TabsTrigger,{value:"one_sample",children:"One-Sample t-Test"})]}),(0,a.jsx)("div",{className:"mt-4",children:(0,a.jsxs)(u.Card,{children:[(0,a.jsxs)(u.CardHeader,{className:"pb-3",children:[(0,a.jsx)(u.CardTitle,{className:"text-sm",children:"Konfigurasi Variabel Uji"}),(0,a.jsx)(u.CardDescription,{className:"text-xs",children:"Pilih variabel dependen berskala numerik dan variabel pengelompokan."})]}),(0,a.jsxs)(u.CardContent,{children:["independent"===C.type&&(0,a.jsx)(b.VariableSelector,{columns:S,slots:[{id:"dv",label:"Dependent Variable (Variabel Terikat)",description:"Variabel hasil/skor (contoh: nilai_literasi, nilai_numerasi)",typeFilter:"numeric",selected:C.dv?[C.dv]:[],onChange:e=>E({dv:e[0]||""})},{id:"groupVar",label:"Grouping Variable (Faktor / 2 Kelompok)",description:"Variabel kategori 2 grup (contoh: jenis_kelamin [L/P], status_sekolah [N/S])",typeFilter:"nominal",selected:C.groupVar?[C.groupVar]:[],onChange:e=>E({groupVar:e[0]||""})}]}),"paired"===C.type&&(0,a.jsx)(b.VariableSelector,{columns:S,slots:[{id:"dv",label:"Pengukuran 1 (Variable 1)",description:"Contoh: nilai_literasi",typeFilter:"numeric",selected:C.dv?[C.dv]:[],onChange:e=>E({dv:e[0]||""})},{id:"pairedVar2",label:"Pengukuran 2 (Variable 2)",description:"Contoh: nilai_numerasi",typeFilter:"numeric",selected:C.pairedVar2?[C.pairedVar2]:[],onChange:e=>E({pairedVar2:e[0]||""})}]}),"one_sample"===C.type&&(0,a.jsxs)("div",{className:"space-y-4",children:[(0,a.jsx)(b.VariableSelector,{columns:S,slots:[{id:"dv",label:"Test Variable (Variabel Terikat)",description:"Variabel numerik yang akan dibandingkan dengan patokan",typeFilter:"numeric",selected:C.dv?[C.dv]:[],onChange:e=>E({dv:e[0]||""})}]}),(0,a.jsxs)("div",{className:"p-3 bg-zinc-50 dark:bg-zinc-800/40 rounded-lg border border-zinc-200 dark:border-zinc-800 flex items-center gap-3 w-72",children:[(0,a.jsx)("span",{className:"text-xs font-semibold text-zinc-700 dark:text-zinc-300",children:"Nilai Uji Acuan (μ₀):"}),(0,a.jsx)(g.Input,{type:"number",value:C.testValue,onChange:e=>E({testValue:Number(e.target.value)}),className:"w-24 h-8 text-xs bg-white dark:bg-zinc-900"})]})]})]})]})})]}),D&&(0,a.jsx)("div",{className:"p-3 rounded-lg bg-red-50 dark:bg-red-950/40 text-red-700 dark:text-red-300 text-xs border border-red-200 dark:border-red-900",children:D}),(0,a.jsxs)(p.Tabs,{value:q,onValueChange:L,children:[(0,a.jsx)("div",{className:"flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 pb-2",children:(0,a.jsxs)(p.TabsList,{className:"bg-zinc-100 dark:bg-zinc-800/80 p-1",children:[(0,a.jsx)(p.TabsTrigger,{value:"tables",children:"Tabel Hasil & Grafik"}),(0,a.jsxs)(p.TabsTrigger,{value:"assumptions",className:"flex items-center gap-1.5",children:[(0,a.jsx)(d.ShieldCheck,{className:"w-3.5 h-3.5 text-emerald-500"}),"Uji Asumsi Statistik"]}),(0,a.jsxs)(p.TabsTrigger,{value:"r_console",className:"flex items-center gap-1.5",children:[(0,a.jsx)(l.Terminal,{className:"w-3.5 h-3.5 text-emerald-500"}),"Output Konsol R (Terminal)"]}),(0,a.jsxs)(p.TabsTrigger,{value:"r_code",className:"flex items-center gap-1.5",children:[(0,a.jsx)(s.Code2,{className:"w-3.5 h-3.5 text-blue-500"}),"Sintaks Verifikasi R"]})]})}),(0,a.jsx)(p.TabsContent,{value:"tables",className:"space-y-6 mt-4",children:P?(0,a.jsxs)("div",{className:"space-y-6",children:[(0,a.jsx)(x.GroupMeanChart,{dvName:P.dv,title:`Perbandingan Rata-rata ${P.dv} Antar Kelompok (95% CI)`,data:P.descriptives}),(0,a.jsx)(h.DataTableHasil,{title:`Tabel 1. Hasil Uji-t Perbandingan ${P.dv}`,subtitle:"independent"===P.type?`Perbandingan antara kelompok ${P.group1} dan ${P.group2}`:"paired"===P.type?`Perbandingan berpasangan antara ${P.group1} dan ${P.group2}`:`Perbandingan terhadap nilai acuan μ₀ = ${P.testValue}`,columns:[{header:"Uji Statistik",accessorKey:"testName"},{header:"Statistik t",accessorKey:"tStat",align:"right"},{header:"df",accessorKey:"df",align:"right"},{header:"p-value",accessorKey:"pValue",align:"right"},{header:"Mean Diff (Δ)",accessorKey:"meanDiff",align:"right"},{header:"SE Diff",accessorKey:"seDiff",align:"right"},{header:"95% CI Lower",accessorKey:"ciLower",align:"right"},{header:"95% CI Upper",accessorKey:"ciUpper",align:"right"},{header:"Cohen's d",accessorKey:"cohensD",align:"right"}],data:G,notes:"Catatan: * p < .05, ** p < .01, *** p < .001. Nilai d adalah estimasi ukuran pengaruh Cohen's d."}),void 0!==P.leveneF&&(0,a.jsxs)("div",{className:"p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/60 flex items-center justify-between text-xs",children:[(0,a.jsxs)("div",{children:[(0,a.jsx)("span",{className:"font-semibold text-zinc-900 dark:text-zinc-100",children:"Uji Homogenitas Varians (Levene's Test):"})," ",(0,a.jsxs)("span",{className:"font-mono text-zinc-700 dark:text-zinc-300",children:["F(1, ",P.df,") = ",(0,T.formatNumber)(P.leveneF),", p = ",(0,T.formatPValue)(P.leveneP)]})]}),(0,a.jsx)(f.Badge,{variant:P.leveneP>=.05?"success":"warning",className:"text-[11px]",children:P.leveneP>=.05?"Varians Homogen (Gunakan Student t)":"Varians Heterogen (Gunakan Welch t)"})]}),(0,a.jsx)(h.DataTableHasil,{title:"Tabel 2. Statistik Deskriptif per Kelompok",columns:[{header:"Kelompok",accessorKey:"group"},{header:"N",accessorKey:"n",align:"right"},{header:"Mean (M)",accessorKey:"mean",align:"right"},{header:"Std. Dev (SD)",accessorKey:"sd",align:"right"},{header:"Std. Error (SE)",accessorKey:"se",align:"right"},{header:"Median",accessorKey:"median",align:"right"}],data:O}),(0,a.jsx)(v.AiCard,{analysisKey:`ttest_${P.dv}_${P.groupVar||""}`,defaultNarrative:(0,w.generateLocalTTestNarrative)(P),promptBuilder:()=>`
